...
import { Eye, Pencil, Trash2, List, Users, CheckCircle, CreditCard, TrendingUp, PlusCircle, Clock, Download, RefreshCw, Flag, ArrowDownLeft, Phone } from "lucide-react";
...
const QuotationTableView = React.memo(({ 
    ...
    isPIView: isPIViewProp, onMoveToPO
}) => {
                                    ...
                                    <td className="px-6 py-5 text-center">
                                        <div className="flex justify-center gap-2">
                                            ...
                                            <button 
                                                ...
                                                className="p-2.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-xl transition-all shadow-sm bg-white dark:bg-gray-800 flex items-center justify-center" 
                                                title="Call Lead"
                                            >
                                                <Phone size={18} className="text-blue-500 dark:text-blue-400 transition-transform hover:scale-110" />
                                            </button>
                                            <button 
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-center text-sm sticky right-0 bg-white dark:bg-gray-800 z-10 border-l border-gray-100 dark:border-gray-700 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.05)] group-hover:bg-gray-50/80 dark:group-hover:bg-gray-700/50 transition-colors">
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <button 
                                            ...
                                            className="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg transition-all flex items-center justify-center" 
                                            title="Call Lead"
                                        >
                                            <Phone size={18} className="text-blue-500 dark:text-blue-400 transition-transform hover:scale-110" />
                                        </button>
...
const TeamInspire = () => {
    ...
    const handleMoveToPO = async (q) => {
        ...
        try {
            ...
            console.error("Error converting PI to PO", err);
            toast.error(err.response?.data?.message || "Failed to convert PI to Purchase Order");
        }
    };
