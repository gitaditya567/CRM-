export const locationData = {
    "Andhra Pradesh": {
        ...
        "Kakinada": [], "Kurnool": [], "Nandyal": [], "NTR": [], "Palnadu": [], "Parvathipuram Manyam": [],
    ...
    "Chhattisgarh": {
        ...
        "Rajnandgaon": [], "Sukma": [], "Surajpur": [], "Surguja": [], "Waikunthpur": []
    },
    "Delhi": {
    ...
    "Rajasthan": {
        ...
        "Jhunjhunu": [], "Jodhpur": [], "Jodhpur Rural": [], "Karauli": [], "Kota": [], "Nagaur": [], "Pali": [],
        "Pratapgarh": [], "Rajsamand": [], "Sawai Madhopur": [], "Sikar": [], "Sirohi": [], "Sri Ganganagar": [],
        "Tonk": [], "Udaipur": [], "Anupgarh": [], "Balotra": [], "Beawar": [], "Deeg": [], "Didwana-Kuchaman": [],
        "Dudu": [], "Gangapur City": [], "Kekri": [], "Khairthal-Tijara": [], "Kotputli-Behror": [],
